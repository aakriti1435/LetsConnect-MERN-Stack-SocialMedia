        ...
        <Fragment>
            ...
            <div ref={searchModal} id="modal1" className="modal">
                <div className="modal-content">
                    <h5>Search Email</h5>
                    <div
                        style={{ marginBottom: "20px", cursor: "auto" }}
                        className="row"
                    >
                                        ...
                                        <Link to={"/profile/" + item._id}>
                                            ...
                                            >
                                                <img
                                                    ...
                                                    src={
                                                        "http://localhost:5000/uploads/profile_pic/" +
                                                        item.profile_pic
                                                    }
                                                    alt={item._id}
                                                />
                ...
                <div className="modal-footer">
                    <a
                        href="#!"
                        className="btn btn-small black white-text modal-close waves-effect"
                    >
                        Cancel
                    </a>
                </div>
